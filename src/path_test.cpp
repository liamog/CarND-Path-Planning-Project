...
TEST(GeneratePaths, CalculateCostMoveOneMeterLessThanDontMove) {
  ...
  double cost_move = PathCost(sdc_path1, others, 0.2);

  Path sdc_path2;
  sdc_path2.emplace_back(0.0, 0.0);
  sdc_path2.emplace_back(0.0, 0.0);
  double cost_dont_move = PathCost(sdc_path2, others, 0.2);
...
TEST(GeneratePaths, CalculateCostCloserToOther) {
  ...
  double cost_closer = PathCost(sdc_path1, others, 0.2);

  Path sdc_path2;
  sdc_path2.emplace_back(0.0, 0.0);
  sdc_path2.emplace_back(1.0, 0.0);
  double cost_further = PathCost(sdc_path2, others, 0.2);
...
TEST(GeneratePaths, CalculateCostBothCollide) {
    ...
    Path sdc_path1;
    sdc_path1.emplace_back(4.0, 0.0);
    sdc_path1.emplace_back(5.0, 0.0);
    sdc_path1.emplace_back(6.0, 0.0);
    sdc_path1.emplace_back(7.0, 0.0);
    sdc_path1.emplace_back(8.0, 0.0);
    double cost_earlier_collision = PathCost(sdc_path1, others, 0.2);

    Path sdc_path2;
    sdc_path2.emplace_back(2.0, 0.0);
    sdc_path2.emplace_back(3.0, 0.0);
    sdc_path2.emplace_back(4.0, 0.0);
    sdc_path2.emplace_back(5.0, 0.0);
    sdc_path2.emplace_back(6.0, 0.0);
    double cost_later_collision = PathCost(sdc_path2, others, 0.2);
